...
2. Navigate to **_Endpoints_** on the left hand side then click the **_Get Started_** tab and **_Copy_** the HTTP Provider Endpoint. Do not adjust the Setup or Security parameters.
